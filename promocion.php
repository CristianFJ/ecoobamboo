        ...
        <header class="row">
         ...
         <div class="row">
             <div id="texto"class="col-xs-12 col-md-10 col-lg-9">
                <h4 id="bienvenido">Bienvenido <?php print($_SESSION['user']); ?>!</h4>
                   <p>
                ...
                <div class="row">
                    <div class="col-xs-5 col-md-4 col-lg-2">
                        <div class="card" >
                            ...
                            <img class="card-img-top" src="img/carbon.jpg" alt="Card image cap">
                                <div class="card-body">
                                    <h5 class="card-title">Travel Case de Bambú + Carbón Activado</h5>
                                    <h6 class="card-title2">18,000$</h6>
                                </div>
                    ...
                    <div class="col-xs-5 col-md-4 col-lg-2">
                        <div class="card" >
                            ...
                            <img class="card-img-top" src="img/carbon.jpg" alt="Card image cap">
                                <div class="card-body">
                                    <h5 class="card-title">Seda Dental + Travel Case de Bambú + Carbón Activado</h5>
                                    <h6 class="card-title2">31,000$</h6>
                                </div>
                            <a id="ver" href="#" class="btn btn-primary">Ver más</a>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-5 col-md-4 col-lg-2">
                        ...
                        <img class="card-img-top" src="img/cubiertos.jpg" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Pitillos en acero Inoxidable + Cubiertos de Bambú</h5>
                                <h6 class="card-title2">27,000$</h6>
                            </div>
                            <a id="ver" href="#" class="btn btn-primary">Ver más</a>
                        </div>
                    </div>
